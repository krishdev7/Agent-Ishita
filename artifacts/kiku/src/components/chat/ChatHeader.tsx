...
export function ChatHeader({ isTyping, onOpenSettings }: ChatHeaderProps) {
  ...
  return (
    <motion.header
      ...
      className="glass-header fixed top-0 left-0 right-0 z-50 px-4 flex items-center justify-between"
      style={{
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            style={{
              background: engineOpen ? 'rgba(255,255,255,0.07)' : 'var(--neon-teal-dim)',
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          <Icon
                            size={11}
                            style={{ color: isActive ? 'var(--neon-teal)' : 'var(--text-muted)' }}
                          />
                        </div>
